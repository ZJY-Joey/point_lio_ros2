...
bool runtime_pos_log, pcd_save_en, path_en, extrinsic_est_en, pub_tf = true, publish_base_outputs = false;
std::string base_output_mode = "b2_tf_chain";
std::string base_odom_frame_id = "world";
std::string base_child_frame_id = "aliengo";
std::string base_tf_parent_frame_id = "aft_mapped";
std::string base_tf_child_frame_id = "aliengo";
...
void readParameters(shared_ptr<rclcpp::Node> &nh) {
    ...
    nh->declare_parameter<bool>("publish.pub_tf", true);
    nh->declare_parameter<bool>("publish.publish_base_outputs", false);
    nh->declare_parameter<std::string>("publish.base_output_mode", "b2_tf_chain");
    nh->declare_parameter<std::string>("publish.base_odom_frame_id", "world");
    nh->declare_parameter<std::string>("publish.base_child_frame_id", "aliengo");
    nh->declare_parameter<std::string>("publish.base_tf_parent_frame_id", "aft_mapped");
    nh->declare_parameter<std::string>("publish.base_tf_child_frame_id", "aliengo");
    ...
    nh->get_parameter("publish.publish_base_outputs", publish_base_outputs);
    nh->get_parameter("publish.base_output_mode", base_output_mode);
    nh->get_parameter("publish.base_odom_frame_id", base_odom_frame_id);
    nh->get_parameter("publish.base_child_frame_id", base_child_frame_id);
    nh->get_parameter("publish.base_tf_parent_frame_id", base_tf_parent_frame_id);
    nh->get_parameter("publish.base_tf_child_frame_id", base_tf_child_frame_id);
